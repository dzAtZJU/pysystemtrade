...
class dataBroker(productionDataLayerGeneric):
    ...
    @property
    def broker_perpetuals_price_data(self) -> brokerPerpetualsPriceData:
        return self.data.broker_perpetuals_price
    ...
    def get_cleaned_prices_at_frequency(
        self, instrument_code, frequency: Frequency,
            cleaning_config = arg_not_supplied
    ) -> futuresContractPrices:

        try:
            broker_prices_raw = \
                    self.get_prices_at_frequency(instrument_code,
                                                             frequency = frequency)
        except missingData:
            return missing_data
    ...
    def get_prices_at_frequency(
        ...
        return self.broker_perpetuals_price_data.get_prices_at_frequency(instrument_code, frequency, return_empty=False)
    ...
    def get_total_capital_value_in_base_currency(self) -> float:
        ...
        return sum(values_across_accounts)
