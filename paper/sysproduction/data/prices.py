...
# )
from paper.sysdata.arctic.arctic_perpetual_prices import (
...
class diagPrices(productionDataLayerGeneric):
    ...
    def get_list_of_instruments(self) -> list:
        list_of_instruments = (
            self.db_perpetuals_prices_data.get_list_of_instruments()
        )
...
class updatePrices(productionDataLayerGeneric):
    ...
    def update_prices_at_frequency(
        self,
        instrument_code,
        frequency: Frequency,
        new_prices: futuresContractPrices,
    ...
    @property
    def db_futures_contract_price_data(self) -> perpetualsPriceData:
        return self.data.db_perpetuals_prices
