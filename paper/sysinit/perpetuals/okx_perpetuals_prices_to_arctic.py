...
def strip_file_names(pathname, date_format):
    ...
    for filename in file_names:
        ...
        csv = futuresContractPrices(pd_readcsv(new_full_name, barchart_csv_config.input_date_index_name, date_format=date_format, input_column_mapping=barchart_csv_config.input_column_mapping, skipfooter=barchart_csv_config.input_skipfooter)).sort_index()
        
        if fre == Frequency.Hour:
